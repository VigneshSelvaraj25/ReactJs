...
var GmailBox = React.createClass({
  ...
  allLabels: function()
  {
      ...
      $.ajax({
       url: 'https://www.googleapis.com/gmail/v1/users/vigneshselvaraj25%40gmail.com/labels?key={AIzaSyDDSwQi_4o9S58qyhq4BJtRVJJwH9DzwFM}',
       dataType: 'json',
       async:false,
       type: 'GET',
  ...
  getLabelWithId: function(labels)
  {
      var accessToken = localStorage.getItem('gToken');
      $.ajax({
       url: 'https://www.googleapis.com/gmail/v1/users/vigneshselvaraj25%40gmail.com/messages?labelIds='+labels.labelId+'&maxResults=10&key={AIzaSyDDSwQi_4o9S58qyhq4BJtRVJJwH9DzwFM}',
       dataType: 'json',
       type: 'GET',
       beforeSend: function (request)
       {
